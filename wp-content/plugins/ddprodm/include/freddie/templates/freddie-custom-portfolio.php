    ...
    function init() {
        ...
        $this->custom_css_fields = array(
            ...
            'active_portfolio_filter' => array(
                ...
                'selector' => '.et_pb_filterable_portfolio .et_pb_portfolio_filters li:nth-child(2) a',
                'no_space_before_selector' => true,
            ),
    ...
    function render( $atts, $content = null, $function_name ) {
        ...
        if( $projects->post_count > 0 ) {
            ...
            <div id="post-<?php the_ID(); ?>" <?php post_class( $main_post_class ); ?>>
                ...
                if ( '' !== $thumb ) : ?>
                    <a class="portfolio_image" href="<?php echo esc_url( $permalink ); ?>">
                ...
                <div class="portfolio_date"><?php echo get_the_date(); ?></div>
                <div class="portfolio_auther"><?php echo get_the_author(); ?></div>
                <?php if ( 'on' === $show_categories ) : ?>
                    <p class="post-meta"><?php echo esc_html($post_meta); ?></p>
                <?php endif; ?>
        ...
        if ( ! $posts = ob_get_clean() ) {
            ...
            $category_filters .= sprintf( '<li class="et_pb_portfolio_filter et_pb_portfolio_filter_all"><a href="#" data-category-slug="all">%1$s</a></li>',
                esc_html__( 'All', 'et_builder' )
            );
            foreach ( $terms as $term  ) {
                $desc = $term->description;
                $category_filters .= sprintf( '<li class="et_pb_portfolio_filter"><a href="#"  data-category-slug="%1$s">%2$s <span class="description">'. $desc .'</span> </a></li>',
