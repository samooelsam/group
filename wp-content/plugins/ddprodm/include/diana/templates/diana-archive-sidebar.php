<?php get_header(); ?>
    ...
    <div id="main-content">
        <div class="entry-content"><?php
            ...
            if((is_category() && get_option(ddpdm_category_page_template) === 'global') || (is_tag() && get_option(ddpdm_tag_page_template) === 'global')) $title_archive = 'Global Archive - Row w Sidebar - PHP Templ - Diana';
