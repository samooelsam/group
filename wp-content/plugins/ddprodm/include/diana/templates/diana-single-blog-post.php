                        ...
                        <?php while ( have_posts() ) : the_post(); ?>
                            ...
                            <article id="post-<?php the_ID(); ?>" <?php post_class( 'et_pb_post' ); ?>>
                                ...
                                <div class="entry-content">
                                 ...
                                 <?php
                                 if(get_theme_mod('ddpdm_single_show_author', true) === 1) {
                                 ?>
                                <div id="author-info">
                            ...
                            <?php } ?>
                            <?php
                                 if(get_theme_mod('ddpdm_single_show_related', true) === 1) {
                                 ?>
                                <div class="relatedposts">
                                    <h3><?php echo esc_attr(get_theme_mod('ddpdm_single_related_header_value', 'You may also like'));?></h3>
                                    <div class="thumbs">
                                    <?php
