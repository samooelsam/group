...
if ( ! class_exists( 'PAnD' ) ) {
	...
	class PAnD {
		...
		public static function dismiss_admin_notice() {
			if(isset($_POST['option_name'])) $option_name        = sanitize_text_field( $_POST['option_name'] ); else wp_die();

			if(isset($_POST['dismissible_length'])) $dismissible_length = sanitize_text_field( $_POST['dismissible_length'] ); else wp_die();
