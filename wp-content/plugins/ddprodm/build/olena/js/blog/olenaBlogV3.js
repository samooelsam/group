(function ($) {
    ...
    setTimeout(function () {
        ...
        if ($('.olena_blog_v3').length !== 0) {
            $('.olena_blog_v3 article.et_pb_post').each(function () {
            ...
            setInterval(function () {
                if (!$('.olena_blog_v3 .et_pb_posts article').hasClass('done')) {
                    $('.olena_blog_v3 .et_pb_post .post-meta').each(function () {
                    ...
                    $('.olena_blog_v3 .et_pb_post').each(function () {
                        $(this).find('.top_date').insertBefore($(this).find('.entry-featured-image-url img'));
                    });


                    $('.olena_blog_v3 .et_pb_posts article').addClass('done');
                }
            }, 50);
        }
