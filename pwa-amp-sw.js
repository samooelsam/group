...
const BASE_CACHE_FILES = [
    'https://www.johnfhunt.co.uk/wp-content/plugins/pwa-for-wp/images/logo.png',
'https://www.johnfhunt.co.uk/wp-content/plugins/pwa-for-wp/images/logo-512x512.png',

];

const OFFLINE_CACHE_FILES = [
     'https://www.johnfhunt.co.uk/?amp=1',
];
...
const OFFLINE_PAGE = 'https://www.johnfhunt.co.uk/?amp=1';
const NOT_FOUND_PAGE = 'https://www.johnfhunt.co.uk/?amp=1';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('https://www.johnfhunt.co.uk//wp-admin/');
//    },
];
